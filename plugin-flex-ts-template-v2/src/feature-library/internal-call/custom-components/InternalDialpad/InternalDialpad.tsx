...
const InternalDialpad = (props: OwnProps) => {
    ...
    return (
        <Box borderTopWidth="borderWidth10" borderTopColor="colorBorder" borderTopStyle="solid" marginTop="space80" paddingTop="space80" paddingBottom="space200" width="100%">
