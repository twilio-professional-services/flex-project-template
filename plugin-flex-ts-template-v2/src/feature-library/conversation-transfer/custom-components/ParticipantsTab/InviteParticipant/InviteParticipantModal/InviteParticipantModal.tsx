...
export const InviteParticipantModal = ({participantModalType, handleClose, handleInviteParticipantClicked} : InviteParticipantModalProps) => {
  const modalHeadingID = useUID();
  const [selectedParticipant, setSelectedParticipant] = useState<ParticipantInvite | null>(null)
  const isOpen = !!participantModalType;
      ...
      <Modal ariaLabelledby={modalHeadingID} isOpen={isOpen} onDismiss={handleClose} size="default">
        ...
        <ModalFooter>
          <ModalFooterActions>
            ...
            <Button variant="primary" disabled={!selectedParticipant} onClick={() => {
