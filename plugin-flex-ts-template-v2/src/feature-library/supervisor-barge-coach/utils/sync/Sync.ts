...
class SyncDocClass {
	...
	initSyncDocAgentAssistance = (agentWorkerSID:string, agentFN:string, conferenceSID:string, selectedTaskSID:string, updateStatus:string) => {
		try {
	...
	// This function takes inputs from other parts of the application to add/remove based on the updateStatus
	// we will adjust the array and eventually pass this into the updateSyncDoc function to update the Sync Doc with the new array
	initSyncDocSupervisors = (agentWorkerSID: string, conferenceSID:string , supervisorSID:string, supervisorFN:string, supervisorStatus:string, updateStatus:string) => {
		try {
