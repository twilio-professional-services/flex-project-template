...
const { enabled = false, agent_coaching_panel = false, supervisor_monitor_panel = false, agent_assistance = false, supervisor_alert_toggle = false } = getFeatureFlags()?.features?.supervisor_barge_coach as SupervisorBargeCoachConfig || {};
