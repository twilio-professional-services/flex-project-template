...
npm rename-template <template-name>
```
4. *OPTIONAL* manually clear the serverless_domain_name in [ui_attributes.dev.json](/flex-config/ui_attributes.dev.json)
