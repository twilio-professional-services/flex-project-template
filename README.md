...
- [Flex Project Template](#flex-project-template)
  - [Feature library Information](#feature-library-information)
- [Setup Guides](#setup-guides)
  - [Local Setup and use](#local-setup-and-use)
    - [Prerequisites](#prerequisites)
    - [Setup](#setup)
    - [development notes](#development-notes)
  - [Setup a project with release pipeline (Recommended)](#setup-a-project-with-release-pipeline-recommended)
  - [Deploying to hosted Flex without a release pipeline (Not Recommended)](#deploying-to-hosted-flex-without-a-release-pipeline-not-recommended)
- [Using template for a standalone plugin](#using-template-for-a-standalone-plugin)
- [Why a template?](#why-a-template)
  - [**One plugin instead of a collection of plugins.**](#one-plugin-instead-of-a-collection-of-plugins)
  - [**When working with one plugin we need a package structure to organize our code**](#when-working-with-one-plugin-we-need-a-package-structure-to-organize-our-code)
  - [**Manage serverless functions with plugins and flex configuration in once place**](#manage-serverless-functions-with-plugins-and-flex-configuration-in-once-place)
  - [**Use Typescript**](#use-typescript)
- [Okay, but why a template for a standalone feature?](#okay-but-why-a-template-for-a-standalone-feature)
- [Okay tell me more, what does it do exactly?](#okay-tell-me-more-what-does-it-do-exactly)
  ...
  - [**scripts**](#scripts)
  - [**.github**](#github)
- [More Scripts Details](#more-scripts-details)
  - [Lint](#lint)
  - [Add feature](#add-feature)
  - [Removing Features](#removing-features)
  - [Renaming template](#renaming-template)
  - [show-env-vars](#show-env-vars)
...
| Callbacks and Voicemail           | _introduce support for callback and voicemail tasks_                                                | [Yes](plugin-flex-ts-template/src/feature-library/callback-and-voicemail/README.md)            | [Yes](plugin-flex-ts-template-v2/src/feature-library/callback-and-voicemail/README.md)           | ✅                 |
...
| Chat Transfer                     | _introduce programmable chat transfer functionality for agents_                                     | [Yes](plugin-flex-ts-template/src/feature-library/chat-transfer/README.md)                     | [Yes](plugin-flex-ts-template-v2/src/feature-library/chat-transfer/README.md)                    |                    |
...
| Keyboard Shortcuts                | _allow agents and supervisors to set and modify keyboard shortcuts_                                 | No                                                                                             | [Yes](plugin-flex-ts-template-v2/src/feature-library/keyboard-shortcuts/README.md)               |                    |
