...
- [Setup Guides](#setup-guides)
  ...
  - [Setup a project with release pipeline](#setup-a-project-with-release-pipeline)
  - [Deploying to hosted Flex without a release pipeline](#deploying-to-hosted-flex-without-a-release-pipeline)
- [Using template for a standalone plugin](#using-template-for-a-standalone-plugin)
- [Why a template?](#why-a-template)
    - [__One plugin instead of a collection of plugins.__](#one-plugin-instead-of-a-collection-of-plugins)
    - [__When working with one plugin we need a package structure to organize our code__](#when-working-with-one-plugin-we-need-a-package-structure-to-organize-our-code)
    - [__Manage serverless functions with plugins and flex configuration in once place__](#manage-serverless-functions-with-plugins-and-flex-configuration-in-once-place)
    - [__Use Typescript__](#use-typescript)
