...
- Features can be turned on and off using an [adminstration panel](/feature-library/flex-v2/admin-ui)
- You can [deploy this solution and use it to build in just a few minutes](/setup-guides/setup-release-pipeline) by cloning the template and providing your account sid, api key and api secret.
