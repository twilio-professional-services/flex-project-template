...
- You can [deploy this solution and use it to build in just a few minutes](/getting-started/install-template) by cloning the template and providing your account sid, api key and api secret.
