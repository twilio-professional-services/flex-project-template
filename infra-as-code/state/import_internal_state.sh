...
importInternalState() {
	...
	echo "var.TWILIO_FLEX_WORKSPACE_SID" | terraform -chdir="../terraform/environments/default" console -input=false -var-file="${ENVIRONMENT:-local}.tfvars" | tr -d '"'
