...
export default abstract class ApiService {
  ...
  constructor() {
    ...
    // use serverless_functions_domain_terazo_platform from ui_attributes, or .env or set as undefined
    ...
    if (custom_data?.serverless_functions_domain_terazo_platform) this.serverlessDomain = custom_data.serverless_functions_domain_terazo_platform;
    ...
    if (!this.serverlessDomain) console.error('serverless_functions_domain_terazo_platform is not set in flex config or env file');
  }
