...
exports.completeTask = async function completeTask (parameters) {
    ...
    try {
        ...
        if (error.code === 20001 || error.code === 20404) {
            ...
            console.warn(`${scriptName}.${arguments.callee.name}(): ${error.message}`);
            return { 
                success: true, 
                status: 200, 
...
exports.createTask = async function createTask (parameters) {
    ...
    const { scriptName, context, workflowSid, taskChannel, attributes, priority: overriddenPriority, timeout: overriddenTimeout, attempts } = parameters;
