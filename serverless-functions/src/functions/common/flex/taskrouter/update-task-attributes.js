...
exports.handler = TokenValidator(async function updateTaskAttributes(context, event, callback) {
    ...
    const requiredParameters = [
        ...
        { key: 'attributesUpdate', purpose: 'object to overwrite on existing task attributes' },
    ];
    ...
    if (parameterError) {
        ...
        try {
            ...
            const result = await TaskOperations.updateTaskAttributes({scriptName,context, taskSid, attributesUpdate, attempts: 0});
